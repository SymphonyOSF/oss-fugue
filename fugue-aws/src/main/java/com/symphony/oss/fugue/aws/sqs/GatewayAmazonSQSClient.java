 ...
 *  ** THE CLASS HAS BEEN MODIFIED IN ORDER TO REDIRECT THE SQS CALLS TO AN  AWS API GATEWAY ENDPOINT **
 * <p>
 * <p>
...
public class GatewayAmazonSQSClient extends AmazonWebServiceClient implements AmazonSQS {

  private URI gatewayEndpoint_;
    ...
    //protected static final com.amazonaws.services.sqs.GatewayAmazonSQSClientConfigurationFactory configFactory = new com.amazonaws.services.sqs.GatewayAmazonSQSClientConfigurationFactory();
     ...
     * @deprecated use {@link GatewayAmazonSQSClientBuilder#defaultClient()}
     */
//    @Deprecated
//    public GatewayAmazonSQSClient() {
...
//    }
     ...
     *
     * @see DefaultAWSCredentialsProviderChain
     * @deprecated use {@link GatewayAmazonSQSClientBuilder#withClientConfiguration(ClientConfiguration)}
     */
    @Deprecated
    public GatewayAmazonSQSClient(ClientConfiguration clientConfiguration) {
     ...
     * @deprecated use {@link GatewayAmazonSQSClientBuilder#withCredentials(AWSCredentialsProvider)} for example:
     *             {@code GatewayAmazonSQSClientBuilder.standard().withCredentials(new AWSStaticCredentialsProvider(awsCredentials)).build();}
     */
//    @Deprecated
//    public GatewayAmazonSQSClient(AWSCredentials awsCredentials) {
...
//    }
     ...
     *        The client configuration options controlling how this client connects to Amazon SQS (ex: proxy settings,
     *        retry counts, etc.).
     * @deprecated use {@link GatewayAmazonSQSClientBuilder#withCredentials(AWSCredentialsProvider)} and
     *             {@link GatewayAmazonSQSClientBuilder#withClientConfiguration(ClientConfiguration)}
     */
    @Deprecated
    public GatewayAmazonSQSClient(AWSCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     * @deprecated use {@link GatewayAmazonSQSClientBuilder#withCredentials(AWSCredentialsProvider)}
     */
//    @Deprecated
//    public GatewayAmazonSQSClient(AWSCredentialsProvider awsCredentialsProvider) {
...
//    }
     ...
     */
    @Deprecated
    public GatewayAmazonSQSClient(AWSCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
     ...
     * @deprecated use {@link GatewayAmazonSQSClientBuilder#withCredentials(AWSCredentialsProvider)} and
     *             {@link GatewayAmazonSQSClientBuilder#withClientConfiguration(ClientConfiguration)} and
     *             {@link GatewayAmazonSQSClientBuilder#withMetricsCollector(RequestMetricCollector)}
     */
    @Deprecated
    public GatewayAmazonSQSClient(AWSCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration, RequestMetricCollector requestMetricCollector) {
    ...
    public static GatewayAmazonSQSClientBuilder builder() {
        return GatewayAmazonSQSClientBuilder.standard();
    }
     ...
     */
    GatewayAmazonSQSClient(AwsSyncClientParams clientParams) {
     ...
     *        Object providing client parameters.
     */
    GatewayAmazonSQSClient(AwsSyncClientParams clientParams, boolean endpointDiscoveryEnabled) {
        super(clientParams);
   ...
   */
  GatewayAmazonSQSClient(AwsSyncClientParams clientParams, String gatewayEndpoint){
      this(clientParams, false);
      
      try
      {
        gatewayEndpoint_ = new URI (gatewayEndpoint);
        
        log.info("Endpoint overridden: "+gatewayEndpoint);
      }
      catch (URISyntaxException e)
      {
        log.error("Invalid Endpoint URL, original endpoint will be used : "+endpoint);
      }
  }
  ...
  private <X, Y extends AmazonWebServiceRequest> Response<X> doInvoke(Request<Y> request, HttpResponseHandler<AmazonWebServiceResponse<X>> responseHandler,
      ...
      if (discoveredEndpoint != null) {
         ...
         request.setEndpoint(gatewayEndpoint_ == null ? endpoint : gatewayEndpoint_);
      }
