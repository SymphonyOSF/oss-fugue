...
public class TestBaseConfigurationProvider
{
  ...
  @Test
  public void testTop() throws NoSuchObjectException
  {
  ...
  public void testMissingTop() throws NoSuchObjectException
  {
    Configuration provider = new Configuration(json_);
  ...
  @Test
  public void testNestOne() throws NoSuchObjectException
  {
    Configuration provider = new Configuration(json_);
  ...
  @Test(expected=NoSuchObjectException.class)
  public void testMissingNestOne() throws NoSuchObjectException
  {
    Configuration provider = new Configuration(json_);
  ...
  @Test
  public void testNestTwo() throws NoSuchObjectException
  {
    Configuration provider = new Configuration(json_);
  ...
  @Test
  public void testNestSubConfig() throws NoSuchObjectException
  {
    Configuration provider = new Configuration(json_);
  ...
  @Test(expected=NoSuchObjectException.class)
  public void testMissingNestTwo() throws NoSuchObjectException
  {
    Configuration provider = new Configuration(json_);
