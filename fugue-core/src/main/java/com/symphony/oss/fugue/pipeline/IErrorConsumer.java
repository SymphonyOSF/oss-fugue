...
/**
 * A closeable consumer of some payload which cannot be processed normally.
 * 
 ...
 */
@NotThreadSafe
public interface IErrorConsumer<T> extends ISimpleErrorConsumer<T>, ICloseableConsumer
{
}
