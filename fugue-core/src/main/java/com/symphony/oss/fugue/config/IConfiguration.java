...
public interface IConfiguration
{
   ...
   * 
   * @throws NoSuchConfigException  If the property is not defined in the current configuration.
   * 
   * @deprecated use getRequiredString(name) or getString(name, defaultValue) - will be deleted after 2018-12-31
   */
  @Deprecated
  String getString(String name) throws NoSuchConfigException;
   ...
   * @throws NoSuchConfigException  If the property is not defined in the current configuration.
   */
  boolean getBoolean(String name) throws NoSuchConfigException;
   ...
   */
  @Deprecated
  List<String> getStringArray(String name) throws NoSuchConfigException;
