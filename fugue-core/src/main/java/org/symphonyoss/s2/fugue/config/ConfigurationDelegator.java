...
public class ConfigurationDelegator implements IConfiguration
{
  ...
  @Override
  @Deprecated
  public String getString(String name) throws NoSuchObjectException
  {
  ...
  @Override
  public boolean getBoolean(String name) throws NoSuchObjectException
  {
  ...
  @Override
  @Deprecated
  public List<String> getStringArray(String name) throws NoSuchObjectException
  {
